...
<html lang="en">
	...
	<?php
$prod="SELECT * FROM `produit` ORDER BY `Reference` DESC ";
$prod1=mysqli_query($lien,$prod);

if(isset($_GET['keyword']) && !empty($_GET['keyword'])){
     $recherche = htmlspecialchars($_GET['keyword']);
     $sql1 ="SELECT * FROM `produit` WHERE `Nom` LIKE '%$recherche%' ORDER BY `Reference` DESC ";
     $prod1 = mysqli_query($lien,$sql1);
}
